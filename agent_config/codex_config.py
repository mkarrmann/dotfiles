...
# TODO: Meta's codex launcher also writes top-level metaLauncherPresetPlugins and
# [marketplaces.*]; regeneration drops both until the next codex launch re-adds them.
