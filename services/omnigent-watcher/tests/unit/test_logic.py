...
from omnigent_watcher.domain import EventKind
from omnigent_watcher.logic import (
...
from omnigent_watcher.source_models import DiffSnapshot
...
def test_summary_is_concise_and_contains_no_raw_detail() -> None:
    ...
    assert summary.startswith("[Watcher dwb_test] D90000001")
