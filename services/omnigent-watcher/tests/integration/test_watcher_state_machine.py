...
from omnigent_watcher.logic import PHABRICATOR_SOURCE
...
from omnigent_watcher.watcher import (
    SubscriptionError,
    Watcher,
)
from tests.support import DiffSourceMixin, apply_snapshot, subscribe_snapshot
...
def test_two_repository_instances_cannot_overlap_one_poll(tmp_path: Path) -> None:
    ...
    assert [watch.subject for watch in claimed_a + claimed_b] == [base.subject]
