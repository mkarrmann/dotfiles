...
from omnigent_diff_watcher.command_source import (
    SOURCE_NAME,
    CommandSource,
    CommandSpec,
)
from omnigent_diff_watcher.domain import EventKind, Lifecycle
...
def test_a_command_watch_holds_its_interval_instead_of_backing_off() -> None:
    ...
    from omnigent_diff_watcher.logic import successful_poll_delay
